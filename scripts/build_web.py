...
.site-nav .nav-label { font-weight: 600; margin-right: 0.5rem; opacity: 0.85; }

@media (max-width: 720px) {
  .site-nav a.level-2 { display: none; }
  .site-nav { font-size: 0.8rem; padding: 0.4rem 0.6rem; }
}
...
footer {
  max-width: var(--max-measure); margin: 0 auto;
  padding: 1.5rem 1.25rem 3rem; font-family: system-ui, sans-serif;
...
@media print {
  .site-nav { position: static; box-shadow: none; background: #fff; color: #000; border-bottom: 1px solid #ccc; }
